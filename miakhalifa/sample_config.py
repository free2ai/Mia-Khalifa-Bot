...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "1635950872:AAEUPmB_txigMboRQjsrMgz2uuslGjz-nqg"
    OWNER_ID = "1530396450"  # If you dont know, run the bot and do /id in your private chat with it
    OWNER_USERNAME = "Raja_Kannada_Admin"
